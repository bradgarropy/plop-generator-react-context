...
```bash
git clone https://github.com/<username>/plop-generator-react-context
```

Next you need to install the dependencies.

```bash
cd plop-generator-react-context
npm install
```
...
[license]: https://github.com/bradgarropy/plop-generator-react-context/blob/master/license
[fork]: https://github.com/bradgarropy/plop-generator-react-context/fork
[contributors]: https://github.com/bradgarropy/plop-generator-react-context#-contributors
